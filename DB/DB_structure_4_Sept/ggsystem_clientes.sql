...
CREATE TABLE `clientes` (
  ...
  `sexo` enum('Hombre','Mujer','Empresa','Indefinido') DEFAULT 'Indefinido',
  `ocupacion` varchar(30) DEFAULT NULL,
  `actividad` varchar(30) DEFAULT NULL,
  `apellido` varchar(50) NOT NULL,
  `status` enum('Activo','Eliminado') NOT NULL DEFAULT 'Activo',
  `info_pago` varchar(50) DEFAULT NULL,
  `notas` varchar(125) DEFAULT NULL,
...
-- Dump completed on 2024-09-04  8:30:21
